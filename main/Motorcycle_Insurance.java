...
public class Motorcycle_Insurance {
    ...
    public static void run(WebDriver driver, WebDriverWait wait, Actions actions) {
...
//        driver.manage().window().maximize();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='main-navigation']//a[@id='nav_motorcycle']"))).click();
        System.out.println("Heading to Motorcycle Insurance Details Page");
//        Actions actions = new Actions(driver);
        ...
        try {
            ...
            try {
                ...
                make_option.click();
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//option[@value = 'Honda']")));
                Select dropdown_make = new Select(make_option);
                dropdown_make.selectByVisibleText("Honda");
            ...
            try {
                WebElement Model_option = driver.findElement(By.xpath("//*[@id=\"model\"]"));
                Model_option.click();
                Select dropdown_model = new Select(Model_option);
                dropdown_model.selectByVisibleText("Motorcycle");
                System.out.println("Model_option Selected");
            } catch (Exception e) {
                System.out.println("Error Making model Selection");
                throw new Exception(e);
            }
            ...
            try {
                ...
                cylinder.sendKeys("150");
                System.out.println("Cylinder Capacity Entered");
            } catch (Exception e) {
                System.out.println("Error Entering Cylinder Capacity");
                throw new Exception(e);
            }
            //engine performance
            try {
                WebElement eng_perf = driver.findElement(By.id("engineperformance"));
                eng_perf.sendKeys("700");
            ...
            // number of seats
            try {
                WebElement no_of_seats = driver.findElement(By.id("numberofseatsmotorcycle"));
                no_of_seats.click();
                Select dropdown_seats = new Select(no_of_seats);
                dropdown_seats.selectByVisibleText("2");
            ...
            //dob
            WebElement date = driver.findElement(By.xpath("//*[@id=\"opendateofbirthcalender\"]"));
            date.click();
            ...
            try {
                ...
                WebElement date1 = driver.findElement(By.xpath("//*[@id=\"openstartdatecalender\"]/i"));
                date1.click();
...
//            Thread.sleep(1000);
            ...
            try {
                ...
                FileUtils.copyFile(ss_capture, new File("C:\\Users\\worka\\Desktop\\New folder\\motorcycle.jpg"));
            ...
            System.out.println("Missing somethings to run. Recheck the code");
