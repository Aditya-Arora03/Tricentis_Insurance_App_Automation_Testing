...
public class Camper_Insurance {

    public static void run(WebDriver driver, WebDriverWait wait, Actions actions) {

        driver.get("https://sampleapp.tricentis.com/101/app.php");
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='main-navigation']//a[@id='nav_camper']"))).click();
        System.out.println("Heading to Camper Insurance Details Page");
        ...
        try {
            ...
            try {
                ...
                dropdown_make.selectByVisibleText("Renault");
            ...
            try {
                ...
                date.click();
                Thread.sleep(1000);
                wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html[1]/body[1]/div[2]/table[1]/tbody[1]/tr[1]/td[3]/a[1]"))).click();
            ...
            try {
                ...
                dropdown_seats.selectByVisibleText("3");
            ...
            //Right hand drive
            try {
                WebElement rhd = driver.findElement(By.xpath("//label[normalize-space()='Yes']"));
                rhd.click();
                System.out.println("Option successfully clicked");
            } catch (Exception e) {
                System.out.println("Error selection option");
                driver.quit();
            ...
            inc.selectByVisibleText("20.000.000,00");
...
//            Thread.sleep(1000);
            ...
            try {
                ...
                FileUtils.copyFile(ss_capture, new File("C:\\Users\\worka\\Desktop\\New folder\\camper_confirm.jpg"));
            ...
            System.out.println("Some error in Camper_Insurance Page...");
            throw new RuntimeException(e);
        }
